...
// an array in js is a data structure to store multiple values of any type under a sin
...
let mixedArray = ["silan", "sritam", "chiku", 24,34,54];
...
// console.log(mixedArray.length - 1);
...
// Array methods :
let bikes = ["pulser","Ninja","KTM","Harley","Triumph"];
// console.log(bikes);
